...
- This leads to one final thing to note: storyForge keeps your manuscript prose safe — after creating an empty chapter file it never edits library text. Codex notes are created and renamed for wikilinks; the Story Context panel can also update a note's Facts section when you explicitly choose Update Codex / Acknowledge. storyForge has no delete function in its code. Combined with automatic backup and proper backup procedures (321 backup is a good place to start), that keeps your masterpiece as safe as I can make it.
