 ...
 * Themed around "kinds of things a story world has": people, places, roles, and institutions.
 */
...
export const ICON_REGISTRY: IconRegistryEntry[] = [
	...
	},
	{
		...
		label: "View chapter",
		source: "custom",
		usedIn: ["RecommendationView.ts — open chapter from synopsis actions"],
	},
	{
		id: ICON_FILE_PLUS,
		label: "Add to chapter",
		source: "custom",
		usedIn: ["RecommendationView.ts — send synopsis to chapter plot"],
	},
	{
	...
	},
	{
		...
		source: "custom",
		usedIn: [
			"main.ts — ribbon icon (repurposed from the storyForge panel's old \"choose layout\" dropdown, now a tab row — see ICON_SERIES's sibling tabs in StoryForgeView.ts)",
		],
	},
	{
		id: ICON_TAG_EDIT,
	...
	},
	{
		...
		source: "custom",
		usedIn: ["StorytellingView.ts — view tab icon"],
	},
	{
	...
	{ id: ICON_BOOKMARK, label: "Bookmark", source: "custom", usedIn: ["iconRegistry.ts — chapter/novel tag icon catalog"] },
	{ id: ICON_BOOKMARK_FILL, label: "Bookmark (filled)", source: "custom", usedIn: ["iconRegistry.ts — chapter/novel tag icon catalog"] },
	{
