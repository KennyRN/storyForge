...
export class StoryForgeSettingsTab extends PluginSettingTab {
	...
	display(): void {
		...
		containerEl.createEl("h4", { text: "Unplaced" });

		const unplacedHeaderGroup = new SettingGroup(containerEl);
		unplacedHeaderGroup
			.addSetting((setting) =>
				setting
					.setName("Header Size")
		...
		const unplacedItemsGroup = new SettingGroup(containerEl);
		...
		containerEl.createEl("h4", { text: "Codex" });

		const codexGroup = new SettingGroup(containerEl);
		codexGroup
			.addSetting((setting) =>
				setting
					.setName("Header Size")
		...
		const codexFolderGroup = new SettingGroup(containerEl);
		codexFolderGroup
			.addSetting((setting) =>
				setting
					.setName("Folder Size")
		...
		const codexNoteLabelGroup = new SettingGroup(containerEl);
		...
		const hideSidebarGroup = new SettingGroup(containerEl);
		hideSidebarGroup
			.addSetting((setting) =>
				setting
		...
		const hidePanelsGroup = new SettingGroup(containerEl);
		hidePanelsGroup
			.addSetting((setting) =>
				setting
		...
		const hideMiscGroup = new SettingGroup(containerEl);
		hideMiscGroup
			.addSetting((setting) =>
				setting
